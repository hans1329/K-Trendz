-- Drop and recreate get_trending_wiki_entries function to include slug field
DROP FUNCTION IF EXISTS public.get_trending_wiki_entries();

CREATE FUNCTION public.get_trending_wiki_entries()
 RETURNS TABLE(
   id uuid, 
   title text, 
   slug text,
